...
// change imageWidth / height to window size
// this would have to be updated in a resize handler
var image;
...
var clickPosition = [window.innerWidth * 0.5, window.innerHeight * 0.5];
...
window.onload = function() {
  ...
  var urls = [
      'https://www.agconsult.com/sites/default/files/blog/2011/02/404-google.gif'
    ],
    image,
    loaded = 0;
...
Fragment.prototype = {
  ...
  clip: function() {
    ...
    this.ctx.closePath();
    this.ctx.clip();
    // draw image to window size
    this.ctx.drawImage(image, 0, 0, window.innerWidth, window.innerHeight);
  }
};


image.addEventListener("animationend", myEndFunction);
  function myEndFunction() {
    window.location.href = "/Vues/pres.html";
}
